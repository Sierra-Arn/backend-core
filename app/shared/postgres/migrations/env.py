# app/postgres/migrations/env.py
import os
import sys
...
from app.shared.postgres.db.models import Base, User, Role, UserRole, RefreshToken, RolePermission, PermissionSQL
from app.shared.postgres.db import postgres_config
