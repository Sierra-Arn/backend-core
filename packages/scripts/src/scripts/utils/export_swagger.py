...
To export the schema to the default location in the current directory:
    pixi run python -m scripts.utils.export_swagger

To specify a custom output path:
    pixi run python -m scripts.utils.export_swagger -o /path/to/custom/openapi.yaml
    pixi run python -m scripts.utils.export_swagger --output /path/to/custom/openapi.yaml
"""
import sys
import argparse
